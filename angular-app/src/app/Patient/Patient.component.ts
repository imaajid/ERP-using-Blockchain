...
export class PatientComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.acme.fypehr.Patient',
      'patientId': this.patientId.value,
      'name': this.name.value,
      'diseas': this.diseas.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.diseas) {
        formObject.diseas = result.diseas;
      } else {
        formObject.diseas = null;
      }
      ...
      if (result.contact_no) {
        formObject.contact_no = result.contact_no;
      } else {
        formObject.contact_no = null;
      }
